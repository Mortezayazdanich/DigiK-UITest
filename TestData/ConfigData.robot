...
${valid_username}=                       mortezayazdani306@gmail.com
${correct_password}=                     mohammadjoon
${logged_in-username}=                   مرتضی یزدانی چراتی
...
${AppleProducts}=                        xpath://*[@id="categories-1"]/ul/li[8]/a[1]
...
#Buy Product
${SellerCheckbox-Digikala}=              css=.c-box:nth-child(7) li:nth-child(1) .c-ui-checkbox__check
...
${Local-CoverType}=                      xpath=//div[@id='js-list-aside']/div[11]/div
...
${Global-CoverType}=                     xpath=//div[@id='js-list-aside']/div[12]/div
${Global-CoverType_paper}=               css=.c-box:nth-child(14) li:nth-child(3) > .c-filter__label
